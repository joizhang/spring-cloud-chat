...
public class CustomOAuth2AccessTokenGenerator implements OAuth2TokenGenerator<OAuth2AccessToken> {
    ...
    public OAuth2AccessToken generate(OAuth2TokenContext context) {
        OAuth2TokenFormat tokenFormat = context.getRegisteredClient()
                .getTokenSettings().getAccessTokenFormat();
        if (!OAuth2TokenType.ACCESS_TOKEN.equals(context.getTokenType()) ||
                !OAuth2TokenFormat.REFERENCE.equals(tokenFormat)) {
            return null;
        }
    ...
    private static final class OAuth2AccessTokenClaims extends OAuth2AccessToken implements ClaimAccessor {
        ...
        private OAuth2AccessTokenClaims(TokenType tokenType, String tokenValue, Instant issuedAt,
                                        Instant expiresAt, Set<String> scopes, Map<String, Object> claims) {
