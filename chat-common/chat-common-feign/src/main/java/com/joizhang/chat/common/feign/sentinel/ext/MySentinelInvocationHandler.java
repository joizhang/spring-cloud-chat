...
public class MySentinelInvocationHandler implements InvocationHandler {
    ...
    MySentinelInvocationHandler(Target<?> target,
    ...
    public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
        switch (method.getName()) {
            case EQUALS:
                try {
                    Object otherHandler = null;
                    if (args.length > 0 && args[0] != null) {
                        otherHandler = Proxy.getInvocationHandler(args[0]);
                    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof MySentinelInvocationHandler) {
